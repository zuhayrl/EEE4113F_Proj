...
\par\noindent\makebox[2.5in]{\includegraphics[width=0.3\linewidth]{Signitures.png}}\hfill\makebox[2.0in]{\today}%

\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%

\par\noindent\makebox[2.5in][l]{Thatohatsi Motlhamme, Moutloatsi Setlogelo,}      \hfill\makebox[2.0in][l]{Date}%
}
\par\noindent\makebox[2.5in][l]{Zuhayr Loonat, and Cameron Clark}